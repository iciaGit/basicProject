function viewerLoad(filePath){
/******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
				console.log("webpackBootstrap");
...
if (document.readyState === 'interactive' || document.readyState === 'complete') {
  ...
  console.log("webViewerLoad event!!");
}
...
var defaultOptions = {
  ...
  cMapUrl: {
    value: 'resources/assets/pdfJs-dist/web/cmaps/',
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
    value: 'resources/assets/pdfJs-dist/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
...
console.log("기본옵션 설정 : ",defaultOptions.defaultUrl);
defaultOptions.defaultUrl.value += filePath;
console.log("기본옵션 설정 : ",defaultOptions.defaultUrl);
